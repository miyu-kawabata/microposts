...
{
    // confirm if already likinging
    $exist = $this->is_liking($micropostId);

    if ($exist) {
        // do nothing if already likinging
        return false;
    } else {
        // favorite if not liking
    ...
    public function unfavorite($micropostId)
{
    ...
    return $this->likings()->where('favorite_id', $micropostId)->exists();
    }
